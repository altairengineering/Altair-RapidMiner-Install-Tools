...
echo "Version 2.0a - 6/161/25 202412 support"
...
sleep 1
#https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2024.1.2-docker-compose-template-prod.zip
...
#pano keycloak fix
sed -i 's%    hostname: panopticon-vizapp$%    hostname: panopticon-vizapp\n    depends_on:\n      keycloak:\n        condition: service_healthy%g' /home/"${aihubuser}"/prod/docker-compose.yml
