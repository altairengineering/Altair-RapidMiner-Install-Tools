...
echo "Version 2.02 - 6/10/25 202510 support"
...
sleep 1
#https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2025.1.0-docker-compose-template-prod.zip
echo "Downloading $hubversion from https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2025.1.0-docker-compose-template-prod.zip"
sleep 1
