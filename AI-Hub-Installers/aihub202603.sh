...
echo "Version 3.1 - 3/17/26 202603 support"
...
sleep 1
echo "Downloading $hubversion from https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2026.0.3-docker-compose-template-prod.zip"
sleep 1
