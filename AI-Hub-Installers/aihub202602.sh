...
echo "Version 3.0 - 2/6/26 202602 support"
echo "Version 2.2 - 6/10/25 202510 support"
echo "Version 2.1 - 12/16/24 202500 support"
		...
		case $LicenseMode in
			...
			"C")
				...
				;;
                        ...
                        "A")
                                echo "Please save the following information:"
								echo "Auth codes are a special install case, please create your auth code on the Altair One Website.  Please wait until you have downloaded all your images with \"docker compose pull\" before creating your auth code, as they are time sensitive.  Edit your .env file with the auth code at the \"LICENSE_UNIT_MANAGER_AUTH_CODE=\" location. Then perform \"docker compose up -d deployment-init\" as normal."
								echo "https://admin.altairone.com/updateprofile"
								echo "Click \"Authorized Machines\" and generate a time sensitive temporary code."
...
sleep 1
#https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2026.0.2-docker-compose-template-prod.zip
echo "Downloading $hubversion from https://docs.rapidminer.com/assets/download/hub/rapidminer-ai-hub-2026.0.2-docker-compose-template-prod.zip"
sleep 1
...
case $LicenseMode in
	...
	"A")
        ...
        sleep 1
		echo "Remember to generate your auth code after pulling images and manually add to \".env\" file."
		;;
	"C")
		#credentials license
...
echo ""
echo "If you used auth code, generate that and configure now in /home/$aihubuser/prod/.env"
echo ""
