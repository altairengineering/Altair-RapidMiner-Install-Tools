...
echo "Version 1.41 - version 9.10.15 1/10/24"
...
sed -i "s/AUTH_SECRET=/AUTH_SECRET=$freshkeycloak/g" /home/$aihubuser/prod/.env

#write in a new password 

sed -i "s/KEYCLOAK_PASSWORD=RapidPass/KEYCLOAK_PASSWORD=$aihubpassword/g" /home/$aihubuser/prod/.env
