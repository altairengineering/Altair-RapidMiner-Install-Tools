...
sleep 1
openssl genpkey -verbose -outform PEM -out /home/"${aihubuser}"/my-certs/ca-root.key -outpubkey /home/"${aihubuser}"/my-certs/ca-root.crt -pkeyopt rsa_keygen_bits:4096
